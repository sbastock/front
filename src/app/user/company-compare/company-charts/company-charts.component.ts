...
export class CompanyChartsComponent implements OnInit {
  ...
  setOption() {
    ...
    const rawData = [['2015/12/31', '3570.47', '3539.18', '-33.69', '-0.94%', '3538.35', '3580.6', '176963664', '25403106', '-'],
